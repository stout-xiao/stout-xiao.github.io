...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    subtitle: '朝朝如是，且谙今日。',
    // site description
    description: 'Stout 的个人博客 — 记录学习、思考与日常洞见。',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: false, // true, false
    // author name
    author: 'Stout',
    // site url
    url: 'https://stout-xiao.github.io',
    // favicon url
  ...
  comment: {
    ...
    // giscus
    // https://giscus.app/
    // To enable: set enabled to true and fill in repo/repoId/category/categoryId from https://giscus.app/
    giscus: {
      repo: '',
      repoId: '',
      category: '',
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/stout-xiao',
      },
      {
        name: 'Email',
        url: 'mailto:shitao_xiao@outlook.com',
      },
      // {
      //   name: 'X',
